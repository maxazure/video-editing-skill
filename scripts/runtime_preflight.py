...
PROFILE_SPECS: Mapping[str, Mapping[str, Any]] = {
    ...
    "multicam_switch": {
        "label": "Audio-guided multicam switching",
        "description": "Analyze aligned per-angle audio, render hard camera cuts, and validate a full H.264/AAC draft.",
        "required": [
            "runtime:python",
            "command:ffmpeg",
            "command:ffprobe",
    ...
    "audio_cue_mix": {
        "label": "Source-bound audio cue mix",
        "description": "Place local or generated SFX against narration and render a reviewable 48 kHz stereo master.",
        "required": [
            "runtime:python",
            "command:ffmpeg",
            "command:ffprobe",
