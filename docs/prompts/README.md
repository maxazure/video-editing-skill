...
| 128 | [Ping-pong Loop 动作素材正放倒放循环](128-ping-pong-loop.md) | progressive CFR 短动作 → 端帧去重正放/倒放、折返/循环双 proof 与 live gate |
...
| 想把一小段手势或产品动作做成没有端帧停顿的正放倒放循环 | [128-Ping-pong Loop](128-ping-pong-loop.md) |
...
| 短背景或环境片要循环到指定次数/时长，并确认接缝没有跳变或爆音 | [117-Loop Fill](117-loop-fill.md) |
